import { Mail, Lock, LogIn } from 'lucide-react'; // Importa ícones necessários
        ...
        <div className="min-h-screen bg-gray-800 flex items-center justify-center p-4">
            ...
            <div className="bg-[#232F3E] rounded-lg shadow-2xl p-8 md:p-10 w-full max-w-md">
                ...
                <div className="space-y-6">
                    ...
                    <button
                        onClick={handleLogin}
                        className="w-full bg-[#FF9900] text-[#232F3E] font-bold py-3 px-4 rounded-md shadow-lg hover:bg-[#E68A00] transition-colors duration-200 flex items-center justify-center space-x-2 cursor-pointer">
                        <LogIn size={20} />
                        <span>LOGIN</span>
                    </button>
                </div>
